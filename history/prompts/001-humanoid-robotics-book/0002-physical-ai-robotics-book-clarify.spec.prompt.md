---
id: "0002"
title: "Physical AI Robotics Book Clarify"
stage: "spec"
date: "2025-12-06"
surface: "agent"
...
user: "user"
command: "/sp.clarify"
labels: ["feature-spec", "clarification", "humanoid-robotics"]
links:
...
5. Integration after EACH accepted answer (incremental update approach):
    ...
    - Append a bullet line immediately after acceptance: `- Q: <question> → A: <final answer>`.n    - Then immediately apply the clarification to the most appropriate section(s):
